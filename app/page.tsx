  ...
  fa: {
    ...
    nav: {
      ...
      whatIs: {
        title: 'بهائیت چیست؟',
        sub: [
          { id: 'whatIs-roots', title: 'ریشه‌های تاریخی' },
          { id: 'whatIs-admin', title: 'ساختار اداری' },
        ],
      },
      history: {
        title: 'تاریخچه و رهبران',
        sub: [
          { id: 'history-babi', title: 'دوران بابیگری' },
          { id: 'history-leaders', title: 'رهبران اصلی' },
        ],
      },
      critique: {
        title: 'نقد علمی',
        sub: [
          { id: 'critique-text', title: 'نقد متون' },
          { id: 'critique-social', title: 'نقد اجتماعی' },
        ],
      },
      doubts: {
        title: 'پاسخ به شبهات',
        sub: [
          { id: 'doubts-history', title: 'شبهات تاریخی' },
          { id: 'doubts-theology', title: 'شبهات کلامی' },
        ],
      },
      ...
      articles: {
        ...
        sub: [
          { id: 'articles-library', title: 'کتابخانه جامع' },
          { id: 'articles-docs', title: 'اسناد پژوهشی' },
        ],
      },
      media: { title: 'رسانه' },
      contact: { title: 'تماس' },
    ...
    pages: {
      ...
      whatIs: {
        title: 'بهائیت چیست؟',
        desc: 'بهائیت یک جنبش دینی است که در قرن نوزدهم در ایران شکل گرفت. مطالعه این موضوع شامل بررسی منابع تاریخی، تحلیل متون اصلی و بررسی زمینه‌های اجتماعی است.',
      },
      history: {
        title: 'تاریخچه و رهبران',
        desc: 'تاریخ شکل‌گیری این آیین با تحولات قرن نوزدهم مرتبط است. مطالعه زندگی و آثار رهبران برای درک تاریخ این جریان اهمیت دارد.',
      },
      critique: {
        title: 'نقد علمی',
        desc: 'در این بخش متون و ادعاهای تاریخی با استفاده از منابع مختلف و روش‌های دانشگاهی بررسی می‌شوند.',
      },
      doubts: {
        title: 'پاسخ به شبهات',
        desc: 'این بخش به بررسی مهم‌ترین پرسش‌ها و شبهات درباره متون و تاریخ این آیین می‌پردازد و پاسخ‌های مستند ارائه می‌کند.',
      },
      mahdism: {
        title: 'مهدویت',
        desc: 'مفهوم مهدویت در اندیشه اسلامی نقش مهمی داشته است. این بخش زمینه‌های تاریخی و فکری این مفهوم را بررسی می‌کند.',
      },
      articles: {
        title: 'مقالات و منابع',
        desc: 'این بخش شامل مجموعه‌ای از منابع پژوهشی، مقالات علمی، اسناد تاریخی و تحقیقات دانشگاهی است.',
      },
      media: {
        title: 'رسانه',
        desc: 'محتوای چندرسانه‌ای شامل ویدیوهای آموزشی، پادکست‌ها، و مستندهای تاریخی.',
      },
      contact: {
        title: 'تماس با ما',
        desc: 'برای ارتباط با تیم پژوهشی فرم زیر را تکمیل کنید.',
      },
    },
    ui: {
      login: 'ورود / ثبت‌نام',
      ...
      footerDesc: 'پایگاه پژوهشی مستقل برای مطالعه متون، اسناد تاریخی و نقد علمی.',
      ...
      videoTitle: 'مستند: ریشه‌های تاریخی در قرن نوزدهم',
      sidebarTitle: 'آخرین بروزرسانی‌ها',
      section1: 'بخش اول: مقدمه و کلیات',
      section2: 'بخش دوم: بررسی تحلیلی و اسناد',
      section3: 'نتیجه‌گیری پژوهش',
      independentResearch: 'پایگاه پژوهشی مستقل',
      fullName: 'نام و نام خانوادگی...',
      email: 'آدرس ایمیل...',
      message: 'پیام یا درخواست پژوهشی خود را بنویسید...',
      send: 'ارسال فرم تماس',
      copyright: 'پایگاه پژوهشی بهائی‌کاوی. تمامی حقوق محفوظ است.',
      twoDaysAgo: '2 روز پیش',
      documentCollection: 'گردآوری اسناد',
      academicAnalysis: 'تحلیل آکادمیک',
      documentedOutput: 'ارائه مستند',
      structuralAnalysis: 'تحلیل ساختاری',
      comprehensiveReview: 'بررسی جامع',
    },
  },
  en: {
    dir: 'ltr',
    nav: {
      ...
      whatIs: {
        ...
        sub: [
          { id: 'whatIs-roots', title: 'Historical Roots' },
          { id: 'whatIs-admin', title: 'Administration' },
        ],
      },
      history: {
        title: 'History',
        sub: [
          { id: 'history-babi', title: 'Babi Era' },
          { id: 'history-leaders', title: 'Key Leaders' },
        ],
      },
      critique: {
        title: 'Critique',
        sub: [
          { id: 'critique-text', title: 'Textual Analysis' },
          { id: 'critique-social', title: 'Social Critique' },
        ],
      },
      doubts: {
        title: 'Doubts',
        sub: [
          { id: 'doubts-history', title: 'Historical' },
          { id: 'doubts-theology', title: 'Theological' },
        ],
      },
      ...
      articles: {
        title: 'Articles',
        sub: [
          { id: 'articles-library', title: 'Library' },
          { id: 'articles-docs', title: 'Documents' },
        ],
      },
      media: { title: 'Media' },
    ...
    pages: {
      ...
      contact: {
        title: 'Contact',
        desc: 'Reach out to our research team.',
      },
    },
    ui: {
      login: 'Login',
      ...
      slide3Title: 'Scientific Review & Responses',
      videoTitle: 'Documentary: Historical Roots',
      ...
      fullName: 'Full name...',
      email: 'Email address...',
      message: 'Write your message or research request...',
      send: 'Send Contact Form',
      copyright: 'Bahai-Kavi Research Platform. All rights reserved.',
      twoDaysAgo: '2 days ago',
      documentCollection: 'Document Collection',
      academicAnalysis: 'Academic Analysis',
      documentedOutput: 'Documented Output',
      structuralAnalysis: 'Structural Analysis',
      comprehensiveReview: 'Comprehensive Review',
    },
  },
  ps: {
    dir: 'rtl',
    nav: {
      ...
      whatIs: {
        title: 'بهائیت څه دی؟',
        sub: [
          { id: 'whatIs-roots', title: 'تاريخي ريښې' },
          { id: 'whatIs-admin', title: 'اداري جوړښت' },
        ],
      },
      history: {
        title: 'تاريخ او مشران',
        sub: [
          { id: 'history-babi', title: 'د بابيانو دوره' },
          { id: 'history-leaders', title: 'مهم مشران' },
        ],
      },
      critique: {
        title: 'علمي نيوکه',
        sub: [
          { id: 'critique-text', title: 'د متونو نيوکه' },
          { id: 'critique-social', title: 'ټولنيزه نيوکه' },
        ],
      },
      doubts: {
        title: 'شبهاتو ته ځوابونه',
        sub: [
          { id: 'doubts-history', title: 'تاريخي شبهات' },
          { id: 'doubts-theology', title: 'عقيدتي شبهات' },
        ],
      },
      mahdism: { title: 'مهدویت' },
      articles: {
        ...
        sub: [
          { id: 'articles-library', title: 'کتابتون' },
          { id: 'articles-docs', title: 'څېړنيز اسناد' },
        ],
      },
      media: { title: 'رسنۍ' },
      contact: { title: 'اړيکه' },
    ...
    pages: {
      home: {
        title: 'کور پاڼه',
        desc: 'دا وېبپاڼه د څېړنې او علمي مطالعې لپاره جوړه شوې ده. دلته د تاريخي اسنادو، متونو او بېلابېلو نظرونو علمي څېړنه وړاندې کېږي.',
      },
      whatIs: {
        title: 'بهائیت څه دی؟',
        desc: 'دلته د تاريخي اسنادو، متونو او بېلابېلو نظرونو علمي څېړنه وړاندې کېږي.',
      },
      history: {
        title: 'تاريخ او مشران',
        desc: 'دلته د تاريخي اسنادو، متونو او بېلابېلو نظرونو علمي څېړنه وړاندې کېږي.',
      ...
      contact: {
        title: 'اړيکه',
        desc: 'د اړيکې لپاره مهرباني وکړئ فورمه ډکه کړئ.',
      },
    },
    ui: {
      login: 'ننوتل',
      latestArticles: 'وروستۍ مقالې',
      ...
      slide3Title: 'علمي څېړنه او ځوابونه',
      videoTitle: 'مستند: په نولسمه پېړۍ کې تاريخي ريښې',
      sidebarTitle: 'وروستي مطالب',
      section1: 'لومړۍ برخه: پېژندنه',
      section2: 'دويمه برخه: تحليلي څېړنه',
      section3: 'پايله',
      independentResearch: 'خپلواکه څېړنیزه اډه',
      fullName: 'بشپړ نوم...',
      email: 'برېښنالیک...',
      message: 'خپل پیغام یا د څېړنې غوښتنه ولیکئ...',
      send: 'د اړیکې فورمه واستوئ',
      copyright: 'د بهائي‌کاوي څېړنیزه پاڼه. ټول حقوق خوندي دي.',
      twoDaysAgo: '2 ورځې مخکې',
      documentCollection: 'د اسنادو راټولونه',
      academicAnalysis: 'اکاډمیک تحلیل',
      documentedOutput: 'مستند وړاندې کول',
      structuralAnalysis: 'جوړښتي تحلیل',
      comprehensiveReview: 'هر اړخیزه ارزونه',
    },
  },
  tk: {
    dir: 'ltr',
    nav: {
      ...
      whatIs: {
        title: 'Bahaizm?',
        sub: [
          { id: 'whatIs-roots', title: 'Taryhy kökler' },
          { id: 'whatIs-admin', title: 'Administrasiýa' },
        ],
      },
      history: {
        title: 'Taryh',
        sub: [
          { id: 'history-babi', title: 'Babi döwri' },
          { id: 'history-leaders', title: 'Esasy Liderler' },
        ],
      },
      critique: {
        title: 'Tankyt',
        sub: [
          { id: 'critique-text', title: 'Tekst derňewi' },
          { id: 'critique-social', title: 'Sosial tankyt' },
        ],
      },
      doubts: {
        title: 'Jogaplar',
        sub: [
          { id: 'doubts-history', title: 'Taryhy şübheler' },
          { id: 'doubts-theology', title: 'Dini şübheler' },
        ],
      },
      ...
      articles: {
        title: 'Makalalar',
        sub: [
          { id: 'articles-library', title: 'Kitaphana' },
          { id: 'articles-docs', title: 'Resminamalar' },
        ],
      },
      media: { title: 'Media' },
    ...
    pages: {
      home: {
        title: 'Baş sahypa',
        desc: 'Bu web sahypasy taryhy çeşmeleri, ýazgylary we dürli garaýyşlary ylmy taýdan öwrenmek üçin döredilen barlag platformasydyr.',
      },
      whatIs: {
        title: 'Bahaizm näme?',
        desc: 'Bu web sahypasy taryhy çeşmeleri...',
      },
      history: {
        title: 'Taryh we Liderler',
        desc: 'Bu web sahypasy taryhy çeşmeleri...',
      },
      critique: {
        title: 'Ylmy tankyt',
      ...
      contact: {
        title: 'Aragatnaşyk',
        desc: 'Topar bilen habarlaşmak üçin.',
      },
    },
    ui: {
      login: 'Giriş',
      ...
      footerDesc: 'Tekstleri öwrenmek üçin garaşsyz gözleg bazasy.',
      readMore: 'Giňişleýin okaň',
      slide1Title: 'Taryhy tekstleri öwreniň',
      slide2Title: 'Taryh we Liderler',
      slide3Title: 'Ylmy gözden geçiriş',
      videoTitle: 'Dokumental film: Taryhy kökler',
      sidebarTitle: 'Soňky neşirler',
      section1: '1-nji bölüm: Giriş',
      section2: '2-nji bölüm: Analitik gözden geçiriş',
      section3: 'Netije',
      independentResearch: 'Garaşsyz gözleg',
      fullName: 'Doly ady...',
      email: 'E-poçta salgysy...',
      message: 'Habaryňyzy ýa-da gözleg haýyşyňyzy ýazyň...',
      send: 'Aragatnaşyk formasyny iber',
      copyright: 'Bahai-Kavi gözleg platformasy. Ähli hukuklar goralan.',
      twoDaysAgo: '2 gün öň',
      documentCollection: 'Resminama ýygnagy',
      academicAnalysis: 'Akademiki derňew',
      documentedOutput: 'Resminamalaşdyrylan çykyş',
      structuralAnalysis: 'Struktura derňewi',
      comprehensiveReview: 'Giňişleýin syn',
    },
  },
} as const;

type LangKey = keyof typeof contentData;
type ContentKey = keyof typeof contentData.fa.pages;
...
export default function App() {
  ...
  let currentPageTitle = t.pages[mainCategory as ContentKey]?.title || '';
  let currentPageDesc = t.pages[mainCategory as ContentKey]?.desc || '';

  if (subCategory) {
    const navItem = t.nav[mainCategory as keyof typeof t.nav] as NavItem | undefined;
  ...
  }, [mainCategory, isTransitioning, slides.length]);
  ...
  const categoryItems: { title: string; icon: string; page: string }[] = [
    {
      title: t.nav.whatIs.title,
    ...
    {
      title: t.nav.critique.title,
      icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
      page: 'critique',
    },
    {
      title: t.nav.mahdism.title,
      icon: 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
      page: 'mahdism',
    },
    {
      title: t.nav.media.title,
  ...
  const leaders = [
    lang === 'fa' || lang === 'ps' ? 'سید علی‌محمد باب' : 'Leader 1',
    lang === 'fa' || lang === 'ps' ? 'میرزا حسین‌علی (بهاءالله)' : 'Leader 2',
    lang === 'fa' || lang === 'ps' ? 'عباس افندی (عبدالبهاء)' : 'Leader 3',
    lang === 'fa' || lang === 'ps' ? 'شوقی افندی' : 'Leader 4',
  ];

  if (isInitialLoad) {
    return (
      <div
        className={`fixed inset-0 ${isDarkMode ? 'bg-[#040d17]' : 'bg-[#f4f6f8]'} flex flex-col items-center justify-center z-[100] ${vazir.className}`}
        dir={isRtl ? 'rtl' : 'ltr'}
        style={{ backgroundImage: isDarkMode ? perfectPatternDark : perfectPatternLight }}
      >
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-500 ${vazir.className} pb-20 ${
        isDarkMode ? 'bg-[#040d17] text-gray-200' : 'bg-[#f4f6f8] text-gray-800'
      }`}
      dir={t.dir}
      style={{ backgroundImage: isDarkMode ? perfectPatternDark : perfectPatternLight }}
    >
        ...
        <header className="flex justify-between items-center bg-white/80 dark:bg-[#0d233a]/80 backdrop-blur-2xl px-5 py-4 rounded-2xl shadow-lg dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] transition-all duration-300 sticky top-4 z-50 border border-white/50 dark:border-white/10">
          ...
          <nav className="hidden lg:flex items-center gap-x-5 text-[#28666e] dark:text-gray-300 font-bold text-[13px] whitespace-nowrap">
            {Object.keys(t.nav).map((key) => {
              const navItem = t.nav[key as keyof typeof t.nav] as NavItem;
              const hasSub = !!navItem.sub?.length;
                ...
                <div key={key} className="relative group">
                  <button
                    ...
                    className={`flex items-center gap-1 py-2 ${
                      mainCategory === key
                        ? 'text-[#033f63] dark:text-[#fedc97] border-b-2 border-[#fedc97]'
                        : 'hover:text-[#033f63] dark:hover:text-white hover:-translate-y-0.5'
                      ...
                      <div className="bg-white/90 dark:bg-[#0f172a]/95 backdrop-blur-xl rounded-xl shadow-xl dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] border border-white/50 dark:border-white/10 overflow-hidden flex flex-col p-1.5">
                        {navItem.sub.map((subItem) => (
                          <div
                            ...
                            className="px-4 py-2.5 text-xs text-gray-700 dark:text-gray-300 hover:bg-[#f4f6f8] dark:hover:bg-white/10 hover:text-[#033f63] dark:hover:text-[#fedc97] rounded-lg transition-colors cursor-pointer"
                          >
                            {subItem.title}
                          </div>
                        ))}
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <button
              ...
              className="p-2.5 rounded-xl bg-white/50 dark:bg-white/10 text-[#033f63] dark:text-[#fedc97] hover:bg-white dark:hover:bg-white/20 transition-all shadow-sm dark:shadow-none border border-white/40 dark:border-white/5"
            >
              {isDarkMode ? (
            ...
            <select
              ...
              className="hidden sm:block bg-white/50 dark:bg-white/10 dark:backdrop-blur-md text-[#033f63] dark:text-gray-200 text-xs font-bold px-2.5 py-2 rounded-xl outline-none cursor-pointer hover:bg-white dark:hover:bg-white/20 transition-all border border-white/40 dark:border-white/5"
            >
              <option value="fa" className="dark:bg-[#0f172a]">
                فارسی
              </option>
              <option value="ps" className="dark:bg-[#0f172a]">
                پښتو
              </option>
              <option value="en" className="dark:bg-[#0f172a]">
                EN
              </option>
              <option value="tk" className="dark:bg-[#0f172a]">
                TK
              </option>
            </select>
            ...
            <button
              ...
              className="lg:hidden p-2 text-[#033f63] dark:text-white"
            >
          ...
          <div className="lg:hidden fixed inset-0 top-20 z-40 bg-white/95 dark:bg-[#040d17]/95 backdrop-blur-2xl overflow-y-auto px-6 py-8 border-t border-gray-100 dark:border-white/10 flex flex-col gap-6">
            <div className="flex gap-4 mb-4">
              <select
                value={lang}
                onChange={(e) => setLang(e.target.value as LangKey)}
                className="flex-1 bg-gray-100 dark:bg-white/10 text-[#033f63] dark:text-white text-sm font-bold px-4 py-3 rounded-xl outline-none border border-transparent dark:border-white/10"
              >
                <option value="fa" className="dark:bg-[#0f172a]">
                  فارسی
                </option>
              ...
              <button className="flex-1 bg-[#033f63] dark:bg-[#fedc97] text-white dark:text-[#040d17] font-bold rounded-xl shadow-md">
                {t.ui.login}
              </button>
            </div>
            ...
            {Object.keys(t.nav).map((key) => {
              ...
              return (
                <div
                  key={key}
                  className="flex flex-col border-b border-gray-100 dark:border-white/10 pb-4"
                >
                  <button
                    onClick={() => handlePageChange(key)}
                    className="text-start font-bold text-[#033f63] dark:text-white text-lg py-2"
                  >
                    {navItem.title}
                  </button>
                    ...
                    >
                      {navItem.sub.map((sub) => (
                        <button
                          ...
                          className="text-start text-sm text-gray-500 dark:text-gray-400 py-1"
                        >
                          {sub.title}
                        </button>
                      ))}
            ...
            <div className="space-y-16 md:space-y-24 mt-4">
              <section className="relative w-full h-[400px] md:h-[550px] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl group border-4 border-white/50 dark:border-white/10">
                <div className="absolute inset-0 transition-opacity duration-1000">
                  ...
                  <div className="absolute inset-0 bg-[#033f63]/70 dark:bg-[#000000]/70 mix-blend-multiply" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#033f63] dark:from-[#040d17] via-transparent to-transparent opacity-80" />
                </div>
                ...
                <div className="absolute inset-0 p-8 md:p-20 flex flex-col justify-center items-start z-10">
                  ...
                  <button
                    ...
                    className="bg-[#fedc97] text-[#033f63] font-black px-8 md:px-12 py-3 md:py-4 rounded-xl md:rounded-2xl shadow-[0_10px_20px_rgba(254,220,151,0.2)] hover:-translate-y-1 transition-all duration-300 text-sm md:text-base"
                  >
                    {t.ui.readMore}
                  </button>
                </div>
                  ...
                  {slides.map((_, i) => (
                    <button
                      ...
                      className={`h-2 rounded-full transition-all duration-500 ${
                        slide === i ? 'w-8 md:w-12 bg-[#fedc97]' : 'w-2 md:w-3 bg-white/40 hover:bg-white/80'
                      }`}
                    />
                  ))}
                </div>
              ...
              <section className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                {infoCards.map((item, i) => (
                  <GlassCard key={i} className="p-6 md:p-8 flex items-start gap-4 md:gap-6 group">
                    ...
                    <div>
                      <h3 className="font-bold text-[#033f63] dark:text-white text-base md:text-lg mb-1.5 line-clamp-1">
                        {item.title}
                      </h3>
                  ...
                  {categoryItems.map((item) => (
                    ...
                    >
                      <div className="w-10 h-10 md:w-14 md:h-14 bg-white dark:bg-white/10 group-hover:bg-[#fedc97] dark:group-hover:bg-[#040d17] group-hover:text-[#033f63] dark:group-hover:text-white rounded-xl md:rounded-2xl mb-2 md:mb-3 flex items-center justify-center transition-colors shadow-sm">
                        <svg className="w-5 h-5 md:w-7 md:h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" d={item.icon} />
                        </svg>
                      </div>
              ...
              <section>
                <h2 className="text-xl md:text-2xl font-black text-[#033f63] dark:text-white border-b-4 border-[#fedc97] pb-2 inline-block mb-6 md:mb-8 drop-shadow-sm">
                  {t.ui.bahaiLeaders}
                </h2>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                  {leaders.map((leader, i) => (
                    <GlassCard
                      ...
                      className="p-4 md:p-6 flex flex-col items-center text-center group"
                    >
                      <div className="w-20 h-20 md:w-28 md:h-28 rounded-full bg-white/50 dark:bg-black/50 mb-4 md:mb-5 overflow-hidden border-[4px] md:border-[6px] border-white/80 dark:border-white/10 group-hover:border-[#7c9885] dark:group-hover:border-[#fedc97] transition-colors relative shadow-inner">
                        <img
                          src={`https://images.unsplash.com/photo-1544717302-de2939b7ef71?q=80&w=200&auto=format&fit=crop&sig=${i}`}
                          alt={leader}
                          className="w-full h-full object-cover opacity-80 grayscale group-hover:grayscale-0 transition-all duration-500"
                        />
                      </div>
                      <h3 className="font-bold text-[#033f63] dark:text-gray-100 text-sm md:text-lg mb-1 md:mb-2">
                        {leader}
                      </h3>
                      <p className="text-xs md:text-sm text-[#7c9885] dark:text-[#fedc97] font-medium opacity-0 group-hover:opacity-100 transition-opacity">
                        {t.ui.readMore}
                      </p>
                    </GlassCard>
                  ))}
              ...
              <section className="relative mt-20 md:mt-24 mb-40 md:mb-56">
                <div className="bg-gradient-to-r from-[#28666e]/90 to-[#7c9885]/90 dark:from-[#0a1a2a]/90 dark:to-[#040d17]/90 backdrop-blur-3xl rounded-[2rem] md:rounded-[3rem] pt-12 md:pt-16 pb-32 md:pb-44 px-6 md:px-14 shadow-xl dark:shadow-[0_8px_32px_rgba(0,0,0,0.5)] relative overflow-hidden border border-white/30 dark:border-white/10">
                  <h2 className="text-2xl md:text-3xl font-black text-white mb-4 md:mb-6 relative z-10 flex items-center gap-3">
                    <svg className="w-6 h-6 md:w-8 md:h-8 text-[#fedc97]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <p className="text-white/80 dark:text-gray-300 max-w-3xl text-sm md:text-lg leading-relaxed font-light relative z-10">
                ...
                <div className="absolute -bottom-28 md:-bottom-40 left-4 right-4 sm:left-14 sm:right-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 z-20">
                  {[
                    ...
                    <GlassCard
                      key={i}
                      onClick={() => handlePageChange('articles-docs')}
                      className="h-56 md:h-72 p-4 md:p-5 flex flex-col justify-between border-t-[4px] md:border-t-[6px] border-t-[#033f63] dark:border-t-[#fedc97]"
                    >
                      <div>
                        ...
                        <h3 className="font-bold text-[#033f63] dark:text-gray-100 text-sm md:text-base line-clamp-2 leading-relaxed">
                          {t.pages.critique.title} - {t.ui.comprehensiveReview} {i + 1}
                        </h3>
                      </div>
                    </GlassCard>
                  ))}
              ...
              <aside className="lg:col-span-1 order-2 lg:order-1 mt-8 lg:mt-0">
                <GlassCard className="p-5 md:p-6 sticky top-28 bg-gradient-to-b from-white/80 to-white/40 dark:from-[#0b243b]/80 dark:to-[#040d17]/80">
                  <h3 className="text-lg md:text-xl font-black mb-4 md:mb-6 text-[#033f63] dark:text-white flex items-center gap-3 border-b border-[#033f63]/10 dark:border-white/20 pb-4">
                    <svg className="w-5 h-5 md:w-6 md:h-6 text-[#7c9885] dark:text-[#fedc97]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        strokeWidth="2"
                  ...
                  <div className="space-y-4 md:space-y-5">
                    {[t.pages.whatIs.title, t.pages.history.title, t.pages.critique.title, t.pages.doubts.title].map(
                      (itemTitle, idx) => (
                        <div
                          key={idx}
                          className="flex gap-3 md:gap-4 items-center group cursor-pointer"
                          onClick={() => handlePageChange('articles-docs')}
                        >
                          ...
                          <div className="flex-1">
                            <h4 className="font-bold text-xs md:text-sm text-[#033f63] dark:text-gray-200 group-hover:text-[#7c9885] dark:group-hover:text-[#fedc97] transition-colors line-clamp-2">
                              {itemTitle} - {t.ui.structuralAnalysis}
                            </h4>
                            <p className="text-[10px] md:text-[11px] text-gray-500 dark:text-gray-500 mt-1">
                              {t.ui.twoDaysAgo}
                            </p>
                          </div>
                        </div>
                ...
                <GlassCard className="p-6 md:p-14 min-h-[60vh] bg-white/80 dark:bg-[#0a192f]/80">
                  <div className="flex flex-col items-center text-center mb-8 md:mb-12">
                    ...
                    <h1 className="text-3xl md:text-5xl font-black text-[#033f63] dark:text-white mb-4 md:mb-6 relative pb-3 md:pb-4 inline-block">
                      {currentPageTitle}
                      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-16 md:w-24 h-1 md:h-1.5 bg-[#fedc97] rounded-full" />
                    </h1>
                  ...
                  {mainCategory !== 'contact' ? (
                    <div className="space-y-8 md:space-y-12">
                      <div className="w-full h-[250px] md:h-[400px] bg-white/50 dark:bg-black/40 rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden shadow-inner relative group border-2 md:border-4 border-white/80 dark:border-white/5">
                        <img
                          ...
                          className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 opacity-90 dark:opacity-70"
                          alt="Content"
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#033f63]/80 dark:from-[#040d17]/90 via-transparent to-transparent" />
                      ...
                      <div>
                        <h2 className="text-xl md:text-2xl font-bold text-[#033f63] dark:text-[#fedc97] mb-3 md:mb-4 flex items-center gap-2">
                          <span className="w-4 h-4 md:w-6 md:h-6 bg-[#fedc97] rounded flex-shrink-0" />
                          {t.ui.section1}
                        </h2>
                        <p className="text-sm md:text-lg text-gray-700 dark:text-gray-300 leading-loose text-justify font-light">
                          ...
                          سطرآنچنان که لازم است. کتابهای زیادی در شصت و سه درصد گذشته، حال و
                          آینده شناخت فراوان جامعه و متخصصان را می طلبد.
                        </p>
                      </div>

                      <div
                        className={`bg-white/60 dark:bg-white/5 backdrop-blur-md p-6 md:p-10 rounded-[1.5rem] md:rounded-[2rem] shadow-sm border border-white/50 dark:border-transparent ${
                          isRtl
                            ? 'border-r-[6px] md:border-r-8 border-[#7c9885] dark:border-[#fedc97]'
                            : 'border-l-[6px] md:border-l-8 border-[#7c9885] dark:border-[#fedc97]'
                        }`}
                      >
                        <h2 className="text-lg md:text-xl font-bold text-[#28666e] dark:text-white mb-4 md:mb-6">
                          {t.ui.section2}
                        </h2>
                        <ul className="space-y-3 md:space-y-4 text-gray-700 dark:text-gray-300 font-medium text-sm md:text-lg">
                          <li className="flex items-start gap-2 md:gap-3">
                            <svg className="w-5 h-5 md:w-6 md:h-6 text-[#7c9885] dark:text-[#fedc97] mt-0.5 md:mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                            </svg>
                            بررسی اسناد و مدارک تاریخی بجا مانده از قرن نوزدهم
                          </li>
                          <li className="flex items-start gap-2 md:gap-3">
                            <svg className="w-5 h-5 md:w-6 md:h-6 text-[#7c9885] dark:text-[#fedc97] mt-0.5 md:mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                            </svg>
                            تحلیل تطبیقی متون و نوشته‌های رهبران جنبش
                          </li>
                          <li className="flex items-start gap-2 md:gap-3">
                            <svg className="w-5 h-5 md:w-6 md:h-6 text-[#7c9885] dark:text-[#fedc97] mt-0.5 md:mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                            </svg>
                            تاثیرات اجتماعی و فرهنگی در بستر جامعه آن زمان
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="w-full max-w-2xl mx-auto bg-white/60 dark:bg-white/5 backdrop-blur-md p-6 md:p-10 rounded-[1.5rem] md:rounded-[2.5rem] border border-white/60 dark:border-white/10 shadow-sm mt-6 md:mt-10">
                      <input
                        ...
                        className="w-full mb-4 md:mb-5 bg-white/80 dark:bg-black/30 dark:text-white border border-white/80 dark:border-white/10 p-3 md:p-4 rounded-xl outline-none focus:border-[#28666e] dark:focus:border-[#fedc97] transition-all text-sm md:text-base"
                      />
                      <input
                        type="email"
                      ...
                      <textarea
                        ...
                        rows={6}
                        className="w-full mb-5 md:mb-6 bg-white/80 dark:bg-black/30 dark:text-white border border-white/80 dark:border-white/10 p-3 md:p-4 rounded-xl outline-none focus:border-[#28666e] dark:focus:border-[#fedc97] transition-all text-sm md:text-base"
                      />
      ...
      <footer className="bg-[#033f63]/90 dark:bg-white/5 backdrop-blur-2xl text-white mt-16 md:mt-24 pt-16 md:pt-20 pb-8 md:pb-10 rounded-t-[3rem] md:rounded-t-[4rem] relative overflow-hidden border-t border-white/20 dark:border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_-10px_40px_rgba(0,0,0,0.4)]">
        <div className="absolute top-0 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-[#28666e] dark:bg-[#fedc97] rounded-full blur-[80px] md:blur-[120px] opacity-40 dark:opacity-20 pointer-events-none" />
        <div className="max-w-[1300px] mx-auto px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-10 mb-8 md:mb-12 text-center md:text-start border-b border-white/10 pb-8 md:pb-12">
            ...
            <div className="flex gap-3 md:gap-4">
              <a
                href="#"
                className="bg-white/10 p-3 md:p-3.5 rounded-xl md:rounded-2xl hover:bg-red-500 transition-all duration-300 shadow-sm backdrop-blur-sm border border-white/10"
              >
              ...
              <a
                href="#"
                className="bg-white/10 p-3 md:p-3.5 rounded-xl md:rounded-2xl hover:bg-pink-500 transition-all duration-300 shadow-sm backdrop-blur-sm border border-white/10"
              >
                <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path
                    fillRule="evenodd"
              ...
              <a
                href="#"
                className="bg-white/10 p-3 md:p-3.5 rounded-xl md:rounded-2xl hover:bg-blue-500 transition-all duration-300 shadow-sm backdrop-blur-sm border border-white/10"
              >
                <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="#"
                className="bg-white/10 p-3 md:p-3.5 rounded-xl md:rounded-2xl hover:bg-blue-400 transition-all duration-300 shadow-sm backdrop-blur-sm border border-white/10"
              >
